...
##def myClick():
##    myLabel1 = tk.Label(root, text="hello " + e.get())
##    myLabel1.pack()
...
button_add=tk.Button(root, text= "+", padx=40, pady=90, command = button_add)
...
button_clear=tk.Button(root, text= "Clear", padx=30, pady=20, command =button_clear)
...
button_add.grid(row=4, rowspan=3 ,column=2)
